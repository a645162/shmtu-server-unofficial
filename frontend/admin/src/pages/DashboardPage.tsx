            ...
            <TableBody>
              {accounts.map((account) => (
                <TableRow key={account.id}>
                  <TableCell>
                    <TableCellLayout>{account.accountId}</TableCellLayout>
                  </TableCell>
                  <TableCell>
                    <TableCellLayout>{account.accountName}</TableCellLayout>
                  </TableCell>
                  <TableCell>
                    <TableCellLayout>
            ...
            <TableBody>
              {recentBills.map((bill) => (
                <TableRow key={bill.id}>
                  <TableCell>
                    <TableCellLayout>{bill.transactionNo}</TableCellLayout>
                  </TableCell>
                  <TableCell>
                    <TableCellLayout>{bill.billDate || '-'}</TableCellLayout>
                  </TableCell>
                  <TableCell>
                    <TableCellLayout>{bill.billType || '-'}</TableCellLayout>
                  </TableCell>
                  <TableCell>
                    <TableCellLayout>{bill.money?.toFixed(2) ?? '-'}</TableCellLayout>
                  </TableCell>
                  <TableCell>
                    <TableCellLayout>{bill.category || '-'}</TableCellLayout>
                  </TableCell>
                  <TableCell>
                    <TableCellLayout>
                      {bill.isNew && (
