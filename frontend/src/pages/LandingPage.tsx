...
import OcrStatusCard from '../components/OcrStatusCard';
...
const useStyles = makeStyles({
  ...
  heroTitle: { maxWidth: '720px', marginBottom: '12px' },
  heroSubtitle: {
    maxWidth: '560px',
    marginBottom: '24px',
  ...
  featureCard: { width: '320px', padding: '24px' },
  cardIcon: { marginBottom: '12px', color: tokens.colorBrandForeground1 },
  ocrSection: {
    marginTop: '16px',
    marginBottom: '40px',
  },
  ...
  featureIcon: { color: tokens.colorBrandForeground1, flexShrink: 0 },
  footer: {
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    ...
    <div className={styles.root}>
      <header className={styles.header}>
        ...
        <div className={styles.headerRight}>
          <RouterLink to="/admin/login">
            <Button appearance="subtle">登录</Button>
          </RouterLink>
          <RouterLink to="/admin/register">
            <Button appearance="primary">注册</Button>
          </RouterLink>
        </div>
      </header>
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          ...
          <RouterLink to="/admin/login">
            <Button appearance="primary" size="large" icon={<ArrowRight24Regular />}>
              开始使用
            </Button>
          </RouterLink>
        </section>
